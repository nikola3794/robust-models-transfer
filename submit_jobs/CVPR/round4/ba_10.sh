...
MODEL_PATH=/cluster/work/cvl/specta/experiment_logs/image_net/rnd_relu/bernoulli_all_b000_200_20211110-164230-vit_relu_rnd_per_dim_deit_small_patch16_224/last.pth.tar
ARCH=vit_rnd_per_dim_deit_small_patch16_224
MIN_SLOPE=-1.0
MAX_SLOPE=-1.0
RND_TYPE=bernoulli_all
...
python src/main_transfer_learning.py \
  ...
  --exp-name $EXP_NAME \
  --out-dir /cluster/work/cvl/specta/experiment_logs/image_net/transfer-learning-round4/ \
  --dataset $DATA_SET \
